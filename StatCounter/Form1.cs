...
namespace StatCounter
{
    public partial class Form1 : Form
    {
        ...
        public void button1_Click(object sender, EventArgs e)
        {
            ...
            double maxRollsCount = 9;
            double maxDifferentStats = 4;
            double maxLvlRolls = 5; //кол-во роллов при прокачке
            ...
            for (int i = 0; i < statNames.Length; i++)
            {
                ...
                if (stats[i] > 0)
                {
                    ...
                    maxRollsCount -= Convert.ToDouble(Math.Ceiling(stats[i] / maximumRolls[i])); // минусуем кол-во роллов от общего числа
                    maxLvlRolls -= (Convert.ToDouble(Math.Ceiling(stats[i] / maximumRolls[i])) - 1); // если роллов в один стат больше одного, тогда отнимаем число доп. роллов
                }
